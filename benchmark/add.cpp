...
common::utils::Circuit<Field> generateCircuit(int nP, int pid) {
    ...
    // shuffle
    auto out = circ.addGate(common::utils::GateType::kAdd, input_vector[0], input_vector[1]);
...
void benchmark(const bpo::variables_map& opts) {
    ...
    Field input_a = NTL::conv<Field>(16);  // First input
    Field input_b = NTL::conv<Field>(7);   // Second input
...
// usage ./../run.sh add --num-parties 3